// Transform-dialect library: vectorize the tiled 8x8x8 compute generic into
// a real FMA-lowerable vector.contract, then lower it to vector.outerproduct
// pre-bufferize (matching cpp/src/MLIRLoweringPasses.cpp's
// VectorContractToOuterProductPass ordering exactly). Ported from
// ../matmul-per-tile-packing/vectorize.mlir unchanged except for the
// function name - this stage is shape-agnostic, it just vectorizes whatever
// linalg.generic remains at this point in the pipeline (rank 3, 8x8x8).
