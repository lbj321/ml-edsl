...
#
# Writes out/{packed,tiled,vectorized,pack_lowered,bufferized,llvm}.mlir.
#
...
echo "[4/6] lower pack/unpack + fold no-op pad"
...
echo "[5/6] bufferize (identity-layout-map, matching addCPUPasses)"
...
echo "[6/6] lower to LLVM dialect"
...
echo
echo "done. IR at each stage: $OUT_DIR/{packed,tiled,vectorized,pack_lowered,bufferized,llvm}.mlir"
