...
class TestTypeHintValidation:
    ...
    def test_all_parameters_need_type_hints(self):
...
class TestPythonTypeHints:
    ...
    def test_python_float_type_hint(self):
    ...
    def test_python_bool_type_hint(self):
...
class TestMLIRTypeHints:
    ...
    def test_mlir_f32_type_hint(self):
    ...
    def test_mlir_i1_type_hint(self):
    ...
    def test_mixed_python_and_mlir_hints(self):
...
class TestExplicitCastOperations:
    ...
    def test_cast_with_constants(self):
...
class TestComplexTypeScenarios:
    ...
    def test_conditional_with_strict_types(self):
    ...
    def test_loop_with_strict_types(self):
