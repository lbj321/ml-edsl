"""Base test class for MLIR tests with IR saving support"""
...
class MLIRTestBase:
    """Base class for MLIR tests with automatic IR saving
    ...
    Usage:
        class TestMyFeature(MLIRTestBase):
            def test_something(self):
                ...
                result = my_func(10)
                assert result == 15
                # IR automatically saved if SAVE_IR=1
    """
    ...
    def teardown_method(self, method):
        ...
        try:
            ...
            # Don't fail test if IR saving fails
